...
class PromptSourceEnum(StrEnum):
    ...
    SPEECH_PROMPT = (
        ...
        "\n"
        "If the work runs across several steps, a short plain-text line before "
        "each one saying where you are is welcome — it is spoken, and silence "
        "while you work sounds like you stopped. Say something different each "
        "time or say nothing; repeating \"let me check that\" is worse than "
        "quiet."
    )
    SMS_PROMPT = (
